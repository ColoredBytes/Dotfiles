...
### [Linux](/linux/)
- [Git Config](/linux/git/git_config.sh) | Tiny script to easily set up `.gitconfig` file.
- [Homebrew Install](/linux/shell/homebrew-install.sh) | Script to install Homebrew and added the `PATH`to `.bashrc`
